...
[TestClass]
public class RetryIntervalStrategyTest
{
    [TestMethod]
    public void sut_is_abstract()
        => typeof(RetryIntervalStrategy).IsAbstract
        .Should().BeTrue("the class should be abstract");
    ...
    public void sut_has_GetInterval_method()
    {
        ...
        var mut = typeof(RetryIntervalStrategy).GetMethod(MethodName);
